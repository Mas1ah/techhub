{{-- resources/views/graphic-cards.blade.php --}}
@extends('layouts.app')

@section('title','Graphic Cards | TechHub')

@section('content')
  <div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h3 class="m-0">Graphic Cards</h3>
      <div class="small text-muted">GPU collection (sample)</div>
    </div>
